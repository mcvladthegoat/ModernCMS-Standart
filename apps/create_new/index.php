<?php
	...
	<br><br><br>
	<p class=header>Create</p><h3><a href=".SERVERADDR."/moderncms/main.php>Go Home</a></h3>
	<div id=lefttab>
	...
	<p><input type=checkbox name=categories[] value=".$sysname.">".$name."</p>";
		...
		<tr><td><textarea rows=30 cols=70 name=text>Type here what you want</textarea></td></tr>";
