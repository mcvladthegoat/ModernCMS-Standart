<?php
	...
	if($_GET["func"] == "group_del"){
		$vkdel = mysql_query("DELETE from vkparser WHERE group_name='$_GET[group_name]' AND website = '$serveraddr_var'", $link);
		mysql_close($link);
		header("Location: index.php");
		exit();
	}
	if($_GET["func"] == "group_create"){
		$vknew = mysql_query("INSERT into vkparser VALUES('$_POST[group_name]', 'true', '$_POST[category_select]', '$serveraddr_var')", $link);
		mysql_close($link);
		header("Location: index.php");
		exit();
	}
